function oeepltd1_1(){
    ...
    var dataoee2 =[];
    var dataoee3 =[];
    document.getElementById("bulan").innerHTML = "OEE ULPLTD/G Trisakti Januari 2020";
    document.getElementById("unit_1").innerHTML = "OEE Mesin Sulzer 12ZV 40/48 Unit 2";
      $.getJSON("https://spreadsheets.google.com/feeds/cells/1evace2mizWsXFf3VaMKQcEbwHZs4tpez-X1NcfIVPRA/2/public/basic?alt=json" ,function (data){
