...
$.getJSON("https://spreadsheets.google.com/feeds/cells/1yY4xJvY-YYrBMb2nGPBomfOWxPGBH4UlkOPNzZGVpnU/3/public/basic?alt=json" ,function (data){
...
$.getJSON("https://spreadsheets.google.com/feeds/cells/1yY4xJvY-YYrBMb2nGPBomfOWxPGBH4UlkOPNzZGVpnU/4/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
...
//get data from google sheet
$.getJSON("https://spreadsheets.google.com/feeds/cells/1yY4xJvY-YYrBMb2nGPBomfOWxPGBH4UlkOPNzZGVpnU/6/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
for (var i = 0; i<gan.length; i++) {
...
//Doughnut chart
  ...
  //get data from google sheet
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1yY4xJvY-YYrBMb2nGPBomfOWxPGBH4UlkOPNzZGVpnU/9/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
