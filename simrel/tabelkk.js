function tabelkk(){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1F7RRznWwy3XNz_5-M0xnlGNuILZf_zjmFmeHAR5lk9U/9/public/basic?alt=json" ,function (data){
    ...
    mesin.innerHTML = "Daftar • Mesin Relokasi ke PLTD Kuala Kurun";
  });
}
function  checkkk(){
  var yoman =[];
...
function tabelrekkk(){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1F7RRznWwy3XNz_5-M0xnlGNuILZf_zjmFmeHAR5lk9U/9/public/basic?alt=json" ,function (data){
    ...
    mesin.innerHTML = "Relokasi • Mesin ke PLTD Kuala Kurun";
