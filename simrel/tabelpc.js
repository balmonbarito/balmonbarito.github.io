function tabelpc(){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1F7RRznWwy3XNz_5-M0xnlGNuILZf_zjmFmeHAR5lk9U/11/public/basic?alt=json" ,function (data){
    ...
    for(var i = 0; i <(label.length/14); i++){
      ...
      tabel += '<td><div class="text-right"><label class="switch"><input type="checkbox" onclick="checkpc();"'+ 'id= "tombol'+ (i+1) +'"' +'><span class="slider round"></span></label></div></td></tr>';
    }
    
    var hasil = document.getElementById('output');
    hasil.innerHTML = tabel;
    var mesin = document.getElementById('mesirek');
    mesin.innerHTML = "Daftar • Mesin Relokasi ke PLTD Puruk Cahu";
  });
}
function  checkpc(){
  var yoman =[];
...
function tabelrekpc(){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1F7RRznWwy3XNz_5-M0xnlGNuILZf_zjmFmeHAR5lk9U/11/public/basic?alt=json" ,function (data){
    ...
    mesin.innerHTML = "Relokasi • Mesin ke PLTD Puruk Cahu";
