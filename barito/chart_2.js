...
function pareto_2(){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/11DfkBQLkWnF5SoYMujmtUDVuWKXxq2vWPMRhCtJgBRA/3/public/basic?alt=json" ,function (data){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/11DfkBQLkWnF5SoYMujmtUDVuWKXxq2vWPMRhCtJgBRA/4/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
  ...
  //get data from google sheet
  $.getJSON("https://spreadsheets.google.com/feeds/cells/11DfkBQLkWnF5SoYMujmtUDVuWKXxq2vWPMRhCtJgBRA/6/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
  ...
  //Doughnut chart
    ...
    //get data from google sheet
    $.getJSON("https://spreadsheets.google.com/feeds/cells/11DfkBQLkWnF5SoYMujmtUDVuWKXxq2vWPMRhCtJgBRA/7/public/basic?alt=json" ,function (data){
      var gan = data.feed.entry;
      for (var i = 0; i<gan.length; i++) {
  ...
  download.innerHTML = '<a class="btn btn-info mt-2" href="https://docs.google.com/spreadsheets/d/e/2PACX-1vThBks3j59feGyFO_9EnUqy76RfgDbsOW3yeoCk77K-Oa2czgy53Bn0Xd1GFwG1YYW3sJvUMilwZyec/pub?gid=1921317437&single=true&output=csv" role="button">Download Data</a>';
}
