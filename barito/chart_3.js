...
function pareto_3(){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1A8cXqGuA0J9MfaPupPysKCdfghYRcqGnai93FontpgE/3/public/basic?alt=json" ,function (data){
  ...
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1A8cXqGuA0J9MfaPupPysKCdfghYRcqGnai93FontpgE/4/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
  ...
  //get data from google sheet
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1A8cXqGuA0J9MfaPupPysKCdfghYRcqGnai93FontpgE/6/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
   ...
   //Doughnut chart
    ...
    //get data from google sheet
    $.getJSON("https://spreadsheets.google.com/feeds/cells/1A8cXqGuA0J9MfaPupPysKCdfghYRcqGnai93FontpgE/7/public/basic?alt=json" ,function (data){
      var gan = data.feed.entry;
      for (var i = 0; i<gan.length; i++) {
  ...
  download.innerHTML = '<a class="btn btn-info mt-2" href="https://docs.google.com/spreadsheets/d/e/2PACX-1vQS8dvHEZfpX3o2s8YlO-UrekGHf-7FofmNnEAXmpgl_F8W8esORzhfNiyzjftni4ISIDMKC60L0x0A/pub?gid=1921317437&single=true&output=csv" role="button">Download Data</a>';
}
//bar chart
