...
title.innerHTML= "SWD 16 TM Mesin 6";

//get data from google sheets
$.getJSON("https://spreadsheets.google.com/feeds/cells/1me4ohVYMAdI6izmbHd_cUxGLyInGJi_NGSnIkDlQ8M83/public/basic?alt=json" ,function (data){
...
$.getJSON("https://spreadsheets.google.com/feeds/cells/1me4ohVYMAdI6izmbHd_cUxGLyInGJi_NGSnIkDlQ8M8/4/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
...
//get data from google sheet
$.getJSON("https://spreadsheets.google.com/feeds/cells/1me4ohVYMAdI6izmbHd_cUxGLyInGJi_NGSnIkDlQ8M8/6/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
 ...
 //Doughnut chart
  ...
  //get data from google sheet
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1me4ohVYMAdI6izmbHd_cUxGLyInGJi_NGSnIkDlQ8M8/7/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
  ...
  download.innerHTML = '<a class="btn btn-info mt-2" href="https://docs.google.com/spreadsheets/d/e/2PACX-1vRvfIXI30ZyhYBdKAFJknNMLmlRRA240b2AU7plx0yA-Qnc-VDNdqdsThbCzxBVIrbc9IkoPetPznNP/pub?gid=1921317437&single=true&output=csv" role="button">Download Data</a>';
