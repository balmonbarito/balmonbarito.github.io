...
title.innerHTML= "SWD 9 TM Mesin 9";
//get data from google sheets
$.getJSON("https://spreadsheets.google.com/feeds/cells/1mvoj75UEklqDudYweB_SDvHjkxH76sdBQC0c9Usrof8/3/public/basic?alt=json" ,function (data){
...
$.getJSON("https://spreadsheets.google.com/feeds/cells/1mvoj75UEklqDudYweB_SDvHjkxH76sdBQC0c9Usrof8/4/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
...
//get data from google sheet
$.getJSON("https://spreadsheets.google.com/feeds/cells/1mvoj75UEklqDudYweB_SDvHjkxH76sdBQC0c9Usrof8/6/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
 ...
 //Doughnut chart
  ...
  //get data from google sheet
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1mvoj75UEklqDudYweB_SDvHjkxH76sdBQC0c9Usrof8/7/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
  ...
  download.innerHTML = '<a class="btn btn-info mt-2" href="https://docs.google.com/spreadsheets/d/e/2PACX-1vTjD5Tg9eUjvR-fDir_lJetLSMNvaLQwpiFeFe1H5nXWYIuY39ga6t-fHU1QgRC7XvgvJHChh8TxOla/pub?gid=1921317437&single=true&output=csv" role="button">Download Data</a>';
