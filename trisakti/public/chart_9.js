...
$.getJSON("https://spreadsheets.google.com/feeds/cells/1BTEGJn31y2zY_w16T-AB2FsD4tIHGRGkiVT-_It9thM/3/public/basic?alt=json" ,function (data){
...
$.getJSON("https://spreadsheets.google.com/feeds/cells/1BTEGJn31y2zY_w16T-AB2FsD4tIHGRGkiVT-_It9thM/4/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
...
//get data from google sheet
$.getJSON("https://spreadsheets.google.com/feeds/cells/1BTEGJn31y2zY_w16T-AB2FsD4tIHGRGkiVT-_It9thM/6/public/basic?alt=json" ,function (data){
  var gan = data.feed.entry;
  for (var i = 0; i<gan.length; i++) {
 ...
 //Doughnut chart
  ...
  //get data from google sheet
  $.getJSON("https://spreadsheets.google.com/feeds/cells/1BTEGJn31y2zY_w16T-AB2FsD4tIHGRGkiVT-_It9thM/9/public/basic?alt=json" ,function (data){
    var gan = data.feed.entry;
    for (var i = 0; i<gan.length; i++) {
